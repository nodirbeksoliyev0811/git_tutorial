...
class MangoContainer extends StatefulWidget {

  const MangoContainer({super.key, required this.img, required this.text, required this.richText, required this.richTitle, required this.richSubtitle, required this.heart});
  ...
  @override
  State<MangoContainer> createState() => _MangoContainerState();
}

class _MangoContainerState extends State<MangoContainer> {
